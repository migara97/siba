...
<div class="container">
            <form class="form-horizontal" method="POST">
                <center><h2 style="font: center;">Update Students</h2></center>
                <br>
             ...
             <div class="form-group"> 
              ...
              <div class="form-group">
                    <label for="cpass" class="col-sm-4 control-label">Current Password </label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="st_Num" class="col-sm-4 control-label">Conform Password</label>
                    <div class="col-sm-6">
